-- O aplicativo também é usado por perfis administrativos em campo.
-- Mantém a função restrita aos papéis operacionais autenticados.
...
begin
  ...
  if caller_tenant_id is null then
    raise exception 'Seu perfil não pode assumir um veículo';
  end if;
